<template>
    <div class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block; background: rgba(255, 255, 255, 0.5)!important;">
		<div class="wedding-cssload-loader">
...
<style>
	...
	.wedding-cssload-loader .cssload-dot {
		position: absolute;
		top: 0;
		left: 0;
		right: 0;
	...
	.wedding-cssload-loader .cssload-dot:before {
		content: '';
		position: absolute;
		top: 0;
		left: 0;
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+1) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+1):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+2) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+2):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+3) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+3):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+4) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+4):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+5) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+5):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+6) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+6):before {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+7) {
		transform: rotate(315deg);
	}
	.wedding-cssload-loader .cssload-dot:nth-child(7n+7):before {
		background: magenta;
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+8) {
	...
	.wedding-cssload-loader .cssload-dot:nth-child(7n+8):before {
