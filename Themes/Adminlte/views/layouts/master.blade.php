...
<head>
    ...
    {!! Theme::script('js/arc-main.js') !!}
    {!! Theme::script('js/custom.js') !!}
    {!! Theme::script('js/toastr.min.js') !!}
    <!-- {!! Theme::script('plugin/bootstrap-datetimepicker/js/moment.min.js') !!} -->
    <!-- {!! Theme::script('plugin/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') !!} -->
    {!! Theme::style('css/lib.min.css') !!}
    {!! Theme::style('css/b-components.min.css') !!}
    <!-- {!! Theme::style('plugin/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') !!} -->
    {!! Theme::style('css/customer.css') !!}
    {!! Theme::style('css/toastr.min.css') !!}
